...
public class EmployeeSortWithComanyAndSalary {
    public static void main(String[] args) {
        // 37. List<Employee>ni company va keyin salary bo‘yicha sort qiling.
        ...
        employees = employees
                .stream()
                .sorted(Comparator.comparing(Employee::getCompany))
